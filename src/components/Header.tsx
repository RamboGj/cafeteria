...
const styles = {
    wrapper: 'max-w-[1280] w-full py-8 px-20 flex justify-between mx-auto',
    ...
    cartLink: 'p-2 rounded-md bg-yellow-100 cursor-pointer hover:scale-x-105 hover:scale-y-105 transition duration-500'
}
